...
$_SG['servidor'] = '200.147.61.73';    // Servidor MySQL
$_SG['usuario'] = 'caopartilhe';          // Usuсrio MySQL
$_SG['senha'] = 'Passwd@pet1';                // Senha MySQL
$_SG['banco'] = 'caopartilhedb';    // Banco de dados MySQL

$_SG['paginaLogin'] = 'login.php'; // Pсgina de login

$_SG['tabela'] = 'tbl_usuario';       // Nome da tabela onde os usuсrios sуo salvos
// ==============================
...
$sql = "SELECT `usu_login`, `usu_nome`, `usu_senha` FROM `".$_SG['tabela']."` WHERE ".$cS." `usu_login` = '".$nusuario."' AND ".$cS." `usu_senha` = '".$nsenha."' AND ativo = 1 LIMIT 1";
//echo $sql;
...
if (empty($resultado)) {
  // echo "Nenhum registro foi encontrado => o usuсrio щ invсlido";
  return false;

} else {
  // echo "O registro foi encontrado => o usuсrio щ valido";
